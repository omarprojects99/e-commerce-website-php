    ...
    <header style="background-color: black;">
        ...
        <a href="index.php">
            ...
            <div class="menu">
                ...
                <a href="login.php" style="text-decoration: none;">Se connecter</a>
                <a href="vendre.php"style="text-decoration: none;">Vendre ma voiture</a>
            </div>
            <div class="social">
        ...
        <div class="col-md-3 offset-md-1" style="border: black;">
            ...
            <!-- <div class="col-md-9">
                ...
                <div class="col-md-7">
                    ...
                    if ($cars) {
                        foreach($cars as $car) {
                            echo '<a href="car.php?id='.$car['car_id'].'" style="text-decoration: none; color: black;"><div class="card mb-3" style="height: 360px; width: 814px; margin-top: 20px;padding: 8px 16px 0px;">
                            <div class="row g-0">
                              <div class="col-md-4">
                              <p class="card-text" style="margin-top :13px;margin-bottom 5px;">'.$car['marque'].' '.$car['model'].'</p>
                                <img src="'.$car['photo'].'" class="img-fluid rounded-start" alt="..." style="width: 269px;height: 200px;margin: top 20px;">
                              </div>
                              <div class="col-md-8">
                                <div class="card-body" style="margin-top: 50px;">
                                
                                   <h5 class="card-title" >'.$car['prix'].'DT'.'</h5>
                                  ...
                                  <p class="card-text"><small class="text-muted">'.$car['marque'].'</small></p>
                                </div>
                              </div>
                            </div>
                          </div></a>';
